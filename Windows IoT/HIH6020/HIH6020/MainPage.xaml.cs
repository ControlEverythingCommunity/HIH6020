...
namespace HIH6020
{
	struct HumdTemp
	{
		...
		/// App that reads data over I2C from an HIH6020, Humidity and Temperature Sensor
		/// </summary>
	...
	public sealed partial class MainPage : Page
	{
		...
		private void TimerCallback(object state)
		{
			...
			try
			{
				...
				addressText = "I2C Address of the Humidity and Temperature Sensor HIH6020: 0x28";
